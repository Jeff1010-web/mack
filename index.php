							...
							<div class="bg_search">
								<div class="container">
								  ...
								  <select name="p_type" class="form-control rounded-pill">
								   ...
								   <select name="p_type" placeholder="Enter Location" class="form-control rounded-pill">
									  <option>Nairobi</option>
									  <option>Kileleshwa</option>
									  <option>Kilimali</option>
									  <option>Wastland</option>
									  <option>Kiambu</option>
									  <option>Runda</option>
									  <option>South C</option>
									  <option>Membly</option>
		...
		<div class="col">
			...
			<div class="card" style="border-radius: 0px 0px 10px 10px;">
				<div class="card-body">
					...
					<h3 class="text-primary">ksh;<?php echo $row['price'] ?></h3>
