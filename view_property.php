...
?>
    ...
    <div class="container">
        ...
        <div style="float: right;">
          <button type="submit" name="favorite" value="Add To Favourite" class="btn-col-desc"><i class="fa fa-heart" aria-hidden="true"></i> &nbsp Add To Favourite </button>
        </div>
...
<a rel="" href="Admin/Regi/lo.php"><input type="button"  name="submit" value="Send Request" class="btn btn-primary rounded-pill mt-2"></a>
