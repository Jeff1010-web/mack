                            ...
                            <li class="nav-divider">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="ManageSales.php">Total Sales </a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="ManageRent.php">Total rentals</a>
                                        </li>
                                        <li class="nav-item">
...
<li class="nav-item">
<a class="nav-link" href="approved-review.php" data-toggle="collapse" aria-expanded="false" data-target="#submenu-212" aria-controls="submenu-2"><i class="fas fa-fw fa-file"></i>Reviews</a>
